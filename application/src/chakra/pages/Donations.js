...
const Donations = () => {
    ...
    const CustomSlider = () => {
        ...
        return (
            <Slider aria-label='slider-ex-6' colorScheme="purple" onChange={(val) => {
                setShowPay(false)
                setShowChoose(false)
                setSliderValue(val)
                // there are 4 marks,
                ...
                result == "Choose" ? document.getElementById("dollar1").innerHTML = `${result}` :
        ...
        <PayPalScriptProvider options={{ "client-id": clientID }}>
            <ChakraProvider>
                ...
                ">
                        ...
                        <ChakraLink className="link" as={Link} to="/" >Home</ChakraLink>
                        ...
                        {showChoose ? <Box className="choose">
                            ...
                            <Box className="chooseinside">
                                ...
                                <Button className="button" onClick={() => {
                                    ...
                                    if (isNumeric(inp.value)) {
                                        document.getElementById("dollar1").innerHTML = `$${inp.value}`
                                        setShowPay(true)
                                    } else {
                        ...
                        {showPay ? <Paypal amount={
                            document.getElementById("dollar1").innerHTML.replace("$", "").replace(": Cancel", "")
                        } /> : null}
                    </Card>
