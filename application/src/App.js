...
const MyVenture = () => {
  ...
  return (
    <div className="my-ventures">
      <h1>My Ventures</h1>
      <p><b>In my years, I have contributed my complete efforts to several companies' visions.</b></p>
    </div>
  )
}
        ...
        <div className="job-div">
          ...
          <div className="desc-div">
            ...
            <h5 className="job-desc">I worked as a Robotics Process Automation (RPA) engineer. I would be given briefings of business processes that needed to
              be automated, and I would be instructed to find an efficient and optimized way of completing these tasks by constructing virtual bots.
            </h5>
            <h5 className="job-desc">
              I began the internship with little experience in intelligent automation, however quickly adapted to the several softwares assigned to me, including
              Automation Anywhere (A360), Power Automate, and many applications included in the Microsoft 365 Apps for Enterprise collection.
            </h5>
          </div>
        </div>
      </FadeInSection>
        ...
        <div className="job-div">
          ...
          <div className="desc-div">
            ...
            <h5 className="job-desc">I volunteered at the Winchester Medical Center to both gain experience in the
              medical field and obtain volunteer hours. The experience was enjoyable, as I was able to grasp a better
              understanding on how roles in the medical field merge into a functional medical system.</h5>
            <h5 className="job-desc">
    ...
    <div className="languages">
      <div className="lang-desc">
        ...
        <div>
          ...
          <p>Java continues to serve as one of the the primary languages in my main GitHub project,
            <br />
            <ChakraLink href="https://github.com/masonmarker/TheMsnProject" color={colors.purple}>TheMsnProject</ChakraLink>
          </p>
        </div>
      </div>
      ...
      <div className="lang-desc">
        ...
        <div>
          ...
          <p>Before class had begun, I had already been informed of the concepts that would be covered in the
            class from some of my upper-classman friends. To get a head-start of these concepts, I
            undertook several front-end development projects on the side that I could use as a baseline for concepts that
            may be touched on when class started. The outcome of the websites were underwhelming from a
            user-experience perspective, however I'm happy to have been learned an incredible portion of basics concepts as
            well as implementation.
          </p>
          <p>It felt great to have entered the class having a grasp on this vital area of computer science. However
            after discovering ReactJS, I quickly shifted away from HTML/CSS/JavaScript to React when the
            class concluded.
          </p>
        </div>
      </div>
      ...
      <div className="lang-desc">
        ...
        <div>
          ...
          <p>Though not my favorite language to code in, I believe C was vital in understanding
            the importance of pointers, memory management, and the use of system calls.
          </p>
          <p>C gave me not only this vital understanding, but also diciplined me when it comes to
            programming. I may not solve school projects in C for days on end, coming with times when
            I would just want to give up. C forced me to find a way to push through and solve
            the problem regardless of how many hours of coding I may rack up.
          </p>
        </div>
      </div>
      ...
      <div className="lang-desc">
        ...
        <div>
          ...
          <p>As an incredibly high-level language, I instantly fell in love with its simplicity
            as a programmer. Though short lived, my experience with Ruby has helped me understand
            the tradeoffs between programming languages, being that higher the level of the language,
            the more likely the language is to have a slower runtime than a lower level language.
          </p>
      ...
      <div className="lang-desc" Style="height: fit-content">
        ...
        <div>
          <p>I've been wanting to learn the in's and out's of the blockchain,
            and I've realized I would eventually need to understand a language capable of
            hosting smart contracts on the blockchain.
          </p>
          <p>After some digging, I found Rust, a generally efficient, pointer based language
            capable of doing exactly that. Due to my previous experience with C, I was
            able to quickly learn the syntax and concepts of Rust.
          </p>
          <p>I'm not currently studying Rust, as I have other languages on my hands,
            however I am eager to learn more about it in the future.
          </p>
        </div>
      </div>
...
function wmcClicked() {
  window.location.href = 'https://www.valleyhealthlink.com/winchester-medical-center/'
}
